...
export const locales: Record<string, CheckinTranslations> = {
  ...
  pt: {
    ...
    checkedInLabel: 'SUCESSO',
    unitLabel: 'Fichas',
  },
  ja: {
    title: 'デイリーチェックイン',
    subtitle: 'チェックインして {coin} {reward} を獲得',
    note: 'ストリークを维持するには、毎日デイリーボーナスを受け取る必要があります！',
    dayLabel: '{num} 日目',
    buttonLabel: '受け取る',
    checkedInLabel: '成功',
    unitLabel: 'トークン',
